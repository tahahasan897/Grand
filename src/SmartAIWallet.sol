...
contract SmartAIWallet {
    ...
    // Address of the GrandToken contract
    ...
    /**
     * @notice Call totalSupply() from GrandToken
     */
    ...
    function getGrandToken() external view returns (address) {
        return address(IGrandToken(i_token)); 
    }
